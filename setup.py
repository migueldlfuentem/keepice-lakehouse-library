...
setup(
    name="keepice-lakehouse-library",
    version="0.0.0",
    license="Apache-2.0",
    description="A library designed to facilitate interaction with Apache Iceberg, abstracting its complexity for end users.",
    long_description="{}\n{}".format(
        re.compile("^.. start-badges.*^.. end-badges", re.M | re.S).sub("", read("README.rst")),
        re.sub(":[a-z]+:`~?(.*?)`", r"``\1``", read("CHANGELOG.rst")),
    ),
    author="Miguel de la Fuente",
    author_email="migueldlfuentem@gmail.com",
    url="https://github.com/migueldlfuentem/keepice-lakehouse-library",
